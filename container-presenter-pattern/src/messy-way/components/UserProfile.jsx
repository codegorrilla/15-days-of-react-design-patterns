            ...
            <div className='profile-header'>
                ...
                {!isEditing ?  (
                    ...
                    <div className='profile-form'>
                        <input type="text" value={formData.name} onChange = {(e)=> handleInputChange('name', e.target.value)} placeholder='Name' />
                        <input type="email" value={formData.email} onChange={(e)=> handleInputChange(email, e.target.value)}  placeholder='Email'/>
                        <textarea value={formData.bio} onChange = {(e)=> handleInputChange(bio, e.target.value)} placeholder='Bio'></textarea>
